...
Предпочтительно использование стандартного функционала уже сертифицированных в соотвтетсвии с закондательством решений. Например, программа «1С:Зарплата и управление персоналом» соответствует требованиям Федерального закона от 27 июля 2006 года №152-ФЗ «О защите персональных данных».
